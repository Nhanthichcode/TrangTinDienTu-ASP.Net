...
namespace Trang_tin_điện_tử_mvc.Controllers
{
    ...
    public class TagsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Slug")] Tag tag)
        {
            if (id != tag.Id)
            {
                TempData["SuccessMessage"] = $"Không tìm thấy thẻ '{tag.Name}'";
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["SuccessMessage"] = $"Đã sửa thẻ '{tag.Name}' thành công!";
                return RedirectToAction(nameof(Index));
            }
            return View(tag);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["SuccessMessage"] = $"Đã xóa thẻ '{tag.Name}' thành công!";
            return RedirectToAction(nameof(Index));
        }
